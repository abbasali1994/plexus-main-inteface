    ...
    >
        <Modal.Header>
            <Modal.Title className="d-flex justify-content-between w-100">
                ...
                <Image src={theme === "light" ? ExitDark : ExitLight} className="exit" width="26px" onClick={() => props.setShow(false)}></Image>
            </Modal.Title>
        </Modal.Header>
        <Modal.Body>
            {props.type === '1INCH' && (
            <Container className="px-0">
                <Row>
                    <Col lg={12} className="justify-content-between align-items-center d-flex">
                        <div>
                            <img src={Rat} alt="" className="user-staking-img mb-1 mr-2" />
                            <img src={ETH} alt="" className="user-staking-img mb-1 mr-2" />
                        </div>
                ...
                <Row className="mt-4">
                    <Col>
                        ...
                        <div className="staking-description-text mt-0">1INCH LIQIDITY POSITION</div>
                    </Col>
                </Row>
                <Row className="mt-3">
                    <Col lg={6} md={6} xs={6} className="pr-0">
                        <div className="user-staking-info-box">
                            <div className="user-staking-info-title-text mb-2">PLX Deposited</div>
                    ...
                    <Col lg={6} md={6} xs={6}>
                        <div className="user-staking-info-box">
                            <div className="user-staking-info-title-text mb-2">ETH Deposited</div>   
                ...
                <Row className="mx-1 mt-3">
                    <div className="stake-description">Stake this position in our yield aggregator to earn both native protocol rewards AND Plexus token rewards.</div>
                </Row>
                <Row className="mt-5 mx-1">
                    <div className="question-text">LOOKING FOR UNWRAP OR REMIX?</div>
                </Row>
                <Row className="mt-3 mx-1 w-75">
                    <div className="question-description">LP tools are currently only available on SushiSwap and Uniswap liquidity positions.</div>
                </Row>
            </Container>
            )}
            ...
            <Container className="px-0">
                <Row>
                    <Col lg={12} className="justify-content-between align-items-center d-flex">
                        <div>
                            <img src={Sushi} alt="" className="user-staking-img mb-1 mr-2" />
                            <img src={ETH} alt="" className="user-staking-img mb-1 mr-2" />
                        </div>
                ...
                <Row className="mt-4">
                    <Col>
                        ...
                        <div className="staking-description-text mt-0">SUSHISWAP LIQIDITY POSITION</div>
                    </Col>
                </Row>
                <Row className="mt-4">
                    <Col lg={6} md={6} xs={6} className="pr-0">
                        <div className="user-staking-info-box">
                            <div className="user-staking-info-title-text mb-2">SUSHI Deposited</div>
                ...
                <Row className="mx-1 mt-3">
                    <div className="stake-description">Withdraw your position into any one asset of your choice with the Unwrap tool.</div>
                </Row>
                <Row className="mt-3 px-3">
                    <Button className="stake-button px-3 mt-2">
                ...
                <Row className="mx-1 mt-3">
                    <div className="stake-description">Alter your position by changing one or both of the assets in the pair with the Remix tool.</div>
                </Row>
            </Container>
            )}
            {props.type === 'UNISWAP' && (
            <Container className="px-0">
                ...
                <Row className="mt-4">
                    <Col>
                        <div className="staking-title-text mb-0">PLX/ETH</div>
                        <div className="staking-description-text mt-0">UNISWAP LIQIDITY POSITION</div>
                    </Col>
                </Row>
                <Row className="mt-4">
                    <Col lg={6} md={6} xs={6} className="pr-0">
