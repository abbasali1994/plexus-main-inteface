...
import RewardsComponent from "./index";
...
describe("Rewards comonent tests", () => {
  const wrapper = shallow(<RewardsComponent />);
  ...
  it("should render Rewards text", () => {
    expect(wrapper.find("h5#rewardsText").text()).toBe("REWARDS");
  });
