            ...
            <Row className="pb-md-4 pb-3">
                <Col md={4} className="mb-2">
                    <div className="py-2 px-3 assets_border_div">
                        <div className="d-flex align-items-center"><img src={ETH} alt="" className="mr-3" /> <span className="text-white font-weight-bold pr-5">ETHEREUM</span></div>
                    </div>
                </Col>
                <Col md={4} className="mb-2">
                    <div className="py-2 px-3 asset_div">
                        <div className="d-flex align-items-center">
                            ...
                            <div> 
                                <h6 className="text-gray-3 font-weight-bold pr-5 mb-0">BSC</h6>
                ...
                <Col md={4} className="mb-2">
                    <div className="py-2 px-3 asset_div">
                        <div className="d-flex align-items-center">
                            ...
                            <div> 
                                <h6 className="text-gray-3 font-weight-bold pr-5 mb-0">SOLANA</h6>
                                <h6 className="mb-0 text-gray-4">COMING SOON</h6>
                            </div>
                        </div>
                    </div>
