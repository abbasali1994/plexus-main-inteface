...
describe('testing the yield sidebar', () => {
    ...
    it("should render yield text", () => {
        expect(screen.getByTestId('yield-sidebar-total-deposited-text')).toHaveTextContent("Total Deposited")
        expect(screen.getByTestId('yield-sidebar-roi-text')).toHaveTextContent("ROI")
        expect(screen.getByTestId('yield-sidebar-your-deposit-text')).toHaveTextContent("Your Deposites:")
        expect(screen.getByTestId('yield-sidebar-approve-text')).toHaveTextContent("APPROVE PLX/ETH SLP")
    })
})
