    ...
    >
      ...
      <Modal.Body>
          <Container className="px-0">
            ...
            <Row className="mt-4">
              <Col lg={6} md={6} xs={6} className="pr-0"><div data-testid="yield-sidebar-your-deposit-text" className="yield-personal-info-title-text">Your Deposites:</div></Col>
              <Col lg={6} md={6} xs={6} className="pr-3"><div data-testid="yield-sidebar-your-deposit-value" className="yield-personal-info-value-text">0.00 SLP</div></Col>
            </Row>
            <Row>
              <Col lg={6} md={6} xs={6} className="pr-0"><div className="yield-personal-info-title-text">Rewards Earned:</div></Col>
              <Col lg={6} md={6} xs={6} className="pr-3"><div className="yield-personal-info-value-text p-0"><img src={Rat} alt="" className="mb-1 mr-1" /><span className="mr-3">0.00</span><img src={Sushi} alt="" className="mb-1 mr-1" /><span>0.00</span></div></Col>
            </Row>
          </Container>
            ...
            <Row className="mt-4">
              <Col >
                <div className="yield-action-button-box">
                  <div className={buttonState === 'deposit' ? "w-30 yield-action-button-text-box active" : "w-30 yield-action-button-text-box"} onClick={() => setButtonState('deposit')}>Deposit</div>
                  <div className={buttonState === 'withdraw' ? "w-30 yield-action-button-text-box active" : "w-30 yield-action-button-text-box"} onClick={() => setButtonState('withdraw')}>Withdraw</div>
                  <div className={buttonState === 'claim' ? "w-40 yield-action-button-text-box active" : "w-40 yield-action-button-text-box"} onClick={() => setButtonState('claim')}>Claim Rewards</div>
                </div>
              </Col>
            </Row>
            <Row className="mt-4">
